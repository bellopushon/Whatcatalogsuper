/*
  # Create sync user plan functions

  1. Functions
    - `get_plan_by_id` - Get plan information by UUID
    - `get_user_by_id` - Get user information by UUID  
    - `update_user_plan` - Update user's plan with validation
    - `insert_system_log` - Insert system log entries
