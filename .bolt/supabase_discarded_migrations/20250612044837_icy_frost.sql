/*
  # Create RPC functions for UUID handling

  1. New Functions
    - `get_plan_by_id` - Get plan by UUID with proper casting
    - `get_user_by_id` - Get user by UUID with proper casting  
    - `update_user_plan` - Update user plan with UUID casting
    - `insert_system_log` - Insert system log with UUID casting
